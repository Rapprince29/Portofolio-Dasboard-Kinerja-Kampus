...
export default function ResetPassword({ token, email }) {
    ...
    return (
        <GuestLayout>
            <Head title="Reset Password — Dashboard KPI PENS" />
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10 border border-white/30">
                ...
                <div className="text-center mb-6 animate-slide-up">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800">
                        Reset <span className="text-pens-500">Password</span>
                    </h1>
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    <div className="animate-slide-up" style={{ animationDelay: '300ms', animationFillMode: 'both' }}>
                        ...
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                <svg className="w-5 h-5 text-gray-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-5.25-4.5h10.5a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25h-10.5a2.25 2.25 0 01-2.25-2.25v-10.5a2.25 2.25 0 012.25-2.25z" />
                                </svg>
                            </div>
                            <input
